...
class AddinStockOut extends StatefulWidget {
  @override
  _AddinStockOutState createState() => _AddinStockOutState();
}

class _AddinStockOutState extends State<AddinStockOut> {
  void addstockInData(Map mapdata) {
    print(mapdata);
    CollectionReference collectionReference =
        // ignore: deprecated_member_use
        Firestore.instance.collection('stockoutdata');

    collectionReference.add(mapdata).catchError((e) {
      print(e.toString());
    });
    print("Data stock out added");
  }
